...
FOREGROUND_CACHE_COALESCE_TIMEOUT_MS=300000
FOREGROUND_CACHE_COALESCE_MAX_ATTEMPTS=2
...
services:
  ...
  core:
    ports: !override
      - "127.0.0.1:4000:4000"
    environment:
      - SKIP_LEAVING_GATEWAYS=${SKIP_LEAVING_GATEWAYS:-true}
  observer:
    ports: !override
      - "127.0.0.1:5050:5050"
  redis:
